...
const { ARGIA_ADMIN_PATH, ARGIA_MICROSOFT_AZURE_SPEECH_TOKEN } = process.env;
...
const ts = new TextToSpeech({
  token: ARGIA_MICROSOFT_AZURE_SPEECH_TOKEN,
  isVerbose: true,
});
...
app.get(ARGIA_ADMIN_PATH, (_req, res) => res.sendFile(PRIVATE_PAGE));
